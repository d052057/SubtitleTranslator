...
- Create Angular project with ng: `ng new subtitletranslator.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`subtitletranslator.client.esproj`).
